...
static const int interval_check_digital_out = 100000; // in us
elapsedMicros us_since_last_check_digital_out;
bool digital_out_status = false;
int check_digital_out_count = 0;
...
void loop() {
  ...
  */
  ...
  if (us_since_last_check_digital_out > interval_check_digital_out) {
		us_since_last_check_digital_out = 0;

		check_digital_out_count ++;
		if (check_digital_out_count >= 20) {
			check_digital_out_count = 0;
			if (digital_out_status == false) {
				digital_out_status = true;
				enable_pin();
			}
			else {
				digital_out_status = false;
				disable_pin();
			}
